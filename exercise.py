...
duaration_milliseconds = sum(track['duration_in_milliseconds'] for track in playlist['tracks'])
duration_seconds = duaration_milliseconds/60
duration_minutes = duration_seconds/60

print("{:.2f} minutes".format(duration_minutes))
# 42.92 minutes
